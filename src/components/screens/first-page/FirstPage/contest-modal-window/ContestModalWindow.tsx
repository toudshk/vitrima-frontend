            ...
            <div className={styles.topBlock}>
              <div className={styles.leftBlock}>
                ...
                <div className={styles.titleBlock}>
                  ...
                  <p className={styles.title}>Выложить минимум 5 своих работ</p>
                </div>
                <div className={styles.titleBlock}>
                  <div className={styles.checkImg}>
                    <RadioButtonUncheckedIcon />
                  </div>
                  <p className={styles.title}>Победить</p>
                </div>
              </div>
              <div className={styles.rightBlock}>
                <p>
                  15 июня мы выберем лучшую работу с точки зрения дизайна,
                  архитектуры и визуализации среди всех участников конкурса.
                  Победителю мы пришлем письмо с указаниями по получению приза.
                  Желаем вам удачи!
                </p>
              </div>
            </div>
