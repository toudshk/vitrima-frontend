...
import { useCarpenter } from "./useCarpetner";
import { ICarpenterInput } from "./ICarpetnerInput";

const AddCarpenterForProject: NextPageAuth = () => {
  const {
    handleSubmit,
    register,
    formState: { errors },
  ...
  const { onSubmit, isLoading , data} = useCarpenter(setValue);
  return (
...
export default AddCarpenterForProject;
